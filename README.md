...
| Release   | Status |
|   ---     |  ---   |
| Latest Build: | [![Build status](https://dev.azure.com/ProphetsWay/ProphetsWay GitHub Projects/_apis/build/status/Utilities/Utilities%20CI)](https://dev.azure.com/ProphetsWay/ProphetsWay GitHub Projects/_build/latest?definitionId=10)
